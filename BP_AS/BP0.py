...
class BpNet:
    ...
    def train(self, x_list, y_list, max_iter=1000, min_E=0.00028, learnRate=0.1):
        ...
        logging.debug('self.output_threshold_list:' + str(self.output_threshold_list))
    ...
    def pre(self, x_list, y_list):
        ...
        # print('list_pre:', list_pre)
        # print('y_list:', y_list)
        return list_pre, y_list, list_judge, list_rate, list_count


def main(name='_main', max_iter=1000, learnRate=0.05):
    startTime = time.time()
    # 实例Bp对象
    ...
    numpy.savetxt('神经网络每次训练全局误差' + name, list_E)
    # 预测
    ...
    return list_rate, list_count, list_all_count, list_pre, y_list, list_E
