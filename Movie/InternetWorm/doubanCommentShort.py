# encoding=utf-8
"""
Name:         doubanCommentShort
Description:  爬取豆瓣电影简短评论（不包括评论人期待电影信息）
Author:       LiuYanZhe
Date:         2019/10/31
"""
# 下载页面
...
# URL = 'https://movie.douban.com/subject/26363254/comments?start='  # 战狼2
# URL = 'https://movie.douban.com/subject/27060077/comments?start='  # 绿皮书
# URL = 'https://movie.douban.com/subject/26266893/comments?start='  # 流浪地球
# URL = 'https://movie.douban.com/subject/26794435/comments?start='  # 哪咤
URL = 'https://movie.douban.com/subject/26931786/comments?start='  # 蜘蛛侠
# 每次爬取的间隔时间
T = 2
# 保存的文件名
# WORKBOOKNAME = '红海行动豆瓣影评.xlsx'
# WORKBOOKNAME = '我和我的祖国豆瓣影评.xlsx'
# WORKBOOKNAME = '至暗时刻豆瓣影评.xlsx'
# WORKBOOKNAME = '三块广告牌豆瓣影评.xlsx'
# WORKBOOKNAME = '战狼2豆瓣影评.xlsx'
# WORKBOOKNAME = '绿皮书豆瓣影评.xlsx'
# WORKBOOKNAME = '流浪地球豆瓣影评.xlsx'
# WORKBOOKNAME = '哪咤豆瓣影评.xlsx'
WORKBOOKNAME = '蜘蛛侠豆瓣影评.xlsx'
'''excel相关'''
# 设置工作目录
os.chdir(WORKSPACE)
