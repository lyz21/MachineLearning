...
from numpy import *
import logging
from Convid19.apriori import DrawUtil
# 漂亮打印
import pprint
from Convid19.apriori import getKeyWords
...
# 载入数据
def loadDate():
    # start=2,end=5是[2,5)。1月1日 对应下标0行，数据2行。则1月25下标24，数据文件的26行。[2,5)写为start=2,endcolum=5。
    # 1月1到1月25：[0,25)，1月26到2.16：[25，47),2.17-3.28
    # 根据news分析
    # data = getKeyWords.getKeyWordsBuNews(20)  # 20为篇文章最多的关键词个数
    # data = getKeyWords.getKeyWordsBuNews(20, startColum=0, endColum=25)  # 20为篇文章最多的关键词个数
    # data = getKeyWords.getKeyWordsBuNews(20, startColum=25, endColum=47)  # 20为篇文章最多的关键词个数
    # data = getKeyWords.getKeyWordsBuNews(20, startColum=47)  # 20为篇文章最多的关键词个数
    # 根据title分析     1月1到1月25：[0,25)，1月26到2.09：[25，40),2.10-3.28
    # data = getKeyWords.getKeyWordsByTitle(20)
    data = getKeyWords.getKeyWordsByTitle(20, startColum=0, endColum=25)
    # data = getKeyWords.getKeyWordsByTitle(20, startColum=26, endColum=40)
    # data = getKeyWords.getKeyWordsByTitle(20, startColum=40)
    # print(data)
...
if __name__ == '__main__':
    ...
    # # DrawUtil.Draw(LISTCORR, SETNODE, '../pic/apriori1.png', title='January 1 to January 25')
    # # DrawUtil.Draw(LISTCORR, SETNODE, '../pic/apriori2.png', title='January 26 to February 16')
    # # DrawUtil.Draw(LISTCORR, SETNODE, '../pic/apriori3.png', title='February 17 to March 28')
    DrawUtil.Draw(LISTCORR, SETNODE, PICNAME, title=TITLE)
